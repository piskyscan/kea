...
.. table:: List of standard DHCPv4 options configurable by an administrator
   ...
   +----------------------------------------+------+---------------------------+-------------+-------------+
   | authenticate                           | 90   | binary                    | false       | false       |
   +----------------------------------------+------+---------------------------+-------------+-------------+
   | client-last-transaction-time           | 91   | uint32                    | false       | false       |
   +----------------------------------------+------+---------------------------+-------------+-------------+
   | associated-ip                          | 92   | ipv4-address              | true        | false       |
   +----------------------------------------+------+---------------------------+-------------+-------------+
...
.. table:: List of standard DHCPv4 options managed by Kea on its own and not directly configurable by an administrator
   ...
   +----------------------------------------+------+---------------------------+-------------+-------------+
   | dhcp-client-identifier                 | 61   | binary                    | false       | true        |
   +----------------------------------------+------+---------------------------+-------------+-------------+
   | fqdn                                   | 81   | record (uint8, uint8,     | false       | true        |
   |                                        |      | uint8, fqdn)              |             |             |
   +----------------------------------------+------+---------------------------+-------------+-------------+
