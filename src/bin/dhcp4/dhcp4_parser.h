...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOKEN_HOST_RESERVATION_IDENTIFIERS = 365, // "host-reservation-identifiers"
    ...
    TOKEN_DUID = 372,              // "duid"
    TOKEN_HW_ADDRESS = 373,        // "hw-address"
    TOKEN_CIRCUIT_ID = 374,        // "circuit-id"
    TOKEN_CLIENT_ID = 375,         // "client-id"
    ...
    TOKEN_TCP = 417,               // "tcp"
    TOKEN_JSON = 418,              // "JSON"
    TOKEN_WHEN_PRESENT = 419,      // "when-present"
    TOKEN_NEVER = 420,             // "never"
    TOKEN_ALWAYS = 421,            // "always"
    TOKEN_WHEN_NOT_PRESENT = 422,  // "when-not-present"
    TOKEN_HOSTNAME_CHAR_SET = 423, // "hostname-char-set"
    TOKEN_HOSTNAME_CHAR_REPLACEMENT = 424, // "hostname-char-replacement"
    TOKEN_IP_RESERVATIONS_UNIQUE = 425, // "ip-reservations-unique"
    ...
    TOKEN_TOPLEVEL_DHCP4 = 436,    // TOPLEVEL_DHCP4
    TOKEN_SUB_DHCP4 = 437,         // SUB_DHCP4
    TOKEN_SUB_INTERFACES4 = 438,   // SUB_INTERFACES4
    TOKEN_SUB_SUBNET4 = 439,       // SUB_SUBNET4
    TOKEN_SUB_POOL4 = 440,         // SUB_POOL4
    TOKEN_SUB_RESERVATION = 441,   // SUB_RESERVATION
    TOKEN_SUB_OPTION_DEFS = 442,   // SUB_OPTION_DEFS
    TOKEN_SUB_OPTION_DEF = 443,    // SUB_OPTION_DEF
    TOKEN_SUB_OPTION_DATA = 444,   // SUB_OPTION_DATA
    TOKEN_SUB_HOOKS_LIBRARY = 445, // SUB_HOOKS_LIBRARY
    TOKEN_SUB_DHCP_DDNS = 446,     // SUB_DHCP_DDNS
    TOKEN_SUB_CONFIG_CONTROL = 447, // SUB_CONFIG_CONTROL
    TOKEN_STRING = 448,            // "constant string"
    TOKEN_INTEGER = 449,           // "integer"
    TOKEN_FLOAT = 450,             // "floating point"
    TOKEN_BOOLEAN = 451            // "boolean"
      };
    ...
    struct symbol_kind
    {
      ...
      {
        YYNTOKENS = 197, ///< Number of tokens.
        S_YYEMPTY = -2,
        ...
        S_HOST_RESERVATION_IDENTIFIERS = 110,    // "host-reservation-identifiers"
        ...
        S_DUID = 117,                            // "duid"
        S_HW_ADDRESS = 118,                      // "hw-address"
        S_CIRCUIT_ID = 119,                      // "circuit-id"
        S_CLIENT_ID = 120,                       // "client-id"
        ...
        S_TCP = 162,                             // "tcp"
        S_JSON = 163,                            // "JSON"
        S_WHEN_PRESENT = 164,                    // "when-present"
        S_NEVER = 165,                           // "never"
        S_ALWAYS = 166,                          // "always"
        S_WHEN_NOT_PRESENT = 167,                // "when-not-present"
        S_HOSTNAME_CHAR_SET = 168,               // "hostname-char-set"
        S_HOSTNAME_CHAR_REPLACEMENT = 169,       // "hostname-char-replacement"
        S_IP_RESERVATIONS_UNIQUE = 170,          // "ip-reservations-unique"
        ...
        S_TOPLEVEL_DHCP4 = 181,                  // TOPLEVEL_DHCP4
        S_SUB_DHCP4 = 182,                       // SUB_DHCP4
        S_SUB_INTERFACES4 = 183,                 // SUB_INTERFACES4
        S_SUB_SUBNET4 = 184,                     // SUB_SUBNET4
        S_SUB_POOL4 = 185,                       // SUB_POOL4
        S_SUB_RESERVATION = 186,                 // SUB_RESERVATION
        S_SUB_OPTION_DEFS = 187,                 // SUB_OPTION_DEFS
        S_SUB_OPTION_DEF = 188,                  // SUB_OPTION_DEF
        S_SUB_OPTION_DATA = 189,                 // SUB_OPTION_DATA
        S_SUB_HOOKS_LIBRARY = 190,               // SUB_HOOKS_LIBRARY
        S_SUB_DHCP_DDNS = 191,                   // SUB_DHCP_DDNS
        S_SUB_CONFIG_CONTROL = 192,              // SUB_CONFIG_CONTROL
        S_STRING = 193,                          // "constant string"
        S_INTEGER = 194,                         // "integer"
        S_FLOAT = 195,                           // "floating point"
        S_BOOLEAN = 196,                         // "boolean"
        S_YYACCEPT = 197,                        // $accept
        S_start = 198,                           // start
        S_199_1 = 199,                           // $@1
        S_200_2 = 200,                           // $@2
        S_201_3 = 201,                           // $@3
        ...
        S_211_13 = 211,                          // $@13
        S_value = 212,                           // value
        S_sub_json = 213,                        // sub_json
        S_map2 = 214,                            // map2
        S_215_14 = 215,                          // $@14
        S_map_value = 216,                       // map_value
        S_map_content = 217,                     // map_content
        S_not_empty_map = 218,                   // not_empty_map
        S_list_generic = 219,                    // list_generic
        S_220_15 = 220,                          // $@15
        S_list_content = 221,                    // list_content
        S_not_empty_list = 222,                  // not_empty_list
        S_list_strings = 223,                    // list_strings
        S_224_16 = 224,                          // $@16
        S_list_strings_content = 225,            // list_strings_content
        S_not_empty_list_strings = 226,          // not_empty_list_strings
        S_unknown_map_entry = 227,               // unknown_map_entry
        S_syntax_map = 228,                      // syntax_map
        S_229_17 = 229,                          // $@17
        S_global_object = 230,                   // global_object
        S_231_18 = 231,                          // $@18
        S_sub_dhcp4 = 232,                       // sub_dhcp4
        S_233_19 = 233,                          // $@19
        S_global_params = 234,                   // global_params
        S_global_param = 235,                    // global_param
        S_valid_lifetime = 236,                  // valid_lifetime
        S_min_valid_lifetime = 237,              // min_valid_lifetime
        S_max_valid_lifetime = 238,              // max_valid_lifetime
        S_renew_timer = 239,                     // renew_timer
        S_rebind_timer = 240,                    // rebind_timer
        S_calculate_tee_times = 241,             // calculate_tee_times
        S_t1_percent = 242,                      // t1_percent
        S_t2_percent = 243,                      // t2_percent
        S_cache_threshold = 244,                 // cache_threshold
        S_cache_max_age = 245,                   // cache_max_age
        S_decline_probation_period = 246,        // decline_probation_period
        S_server_tag = 247,                      // server_tag
        S_248_20 = 248,                          // $@20
        S_echo_client_id = 249,                  // echo_client_id
        S_match_client_id = 250,                 // match_client_id
        S_authoritative = 251,                   // authoritative
        ...
        S_261_23 = 261,                          // $@23
        S_ddns_update_on_renew = 262,            // ddns_update_on_renew
        S_hostname_char_set = 263,               // hostname_char_set
        S_264_24 = 264,                          // $@24
        S_hostname_char_replacement = 265,       // hostname_char_replacement
        S_266_25 = 266,                          // $@25
        S_store_extended_info = 267,             // store_extended_info
        S_statistic_default_sample_count = 268,  // statistic_default_sample_count
        S_statistic_default_sample_age = 269,    // statistic_default_sample_age
        S_ip_reservations_unique = 270,          // ip_reservations_unique
        S_interfaces_config = 271,               // interfaces_config
        S_272_26 = 272,                          // $@26
        S_interfaces_config_params = 273,        // interfaces_config_params
        S_interfaces_config_param = 274,         // interfaces_config_param
        S_sub_interfaces4 = 275,                 // sub_interfaces4
        S_276_27 = 276,                          // $@27
        S_interfaces_list = 277,                 // interfaces_list
        S_278_28 = 278,                          // $@28
        S_dhcp_socket_type = 279,                // dhcp_socket_type
        S_280_29 = 280,                          // $@29
        S_socket_type = 281,                     // socket_type
        S_outbound_interface = 282,              // outbound_interface
        S_283_30 = 283,                          // $@30
        S_outbound_interface_value = 284,        // outbound_interface_value
        S_re_detect = 285,                       // re_detect
        S_lease_database = 286,                  // lease_database
        S_287_31 = 287,                          // $@31
        S_sanity_checks = 288,                   // sanity_checks
        S_289_32 = 289,                          // $@32
        S_sanity_checks_params = 290,            // sanity_checks_params
        S_sanity_checks_param = 291,             // sanity_checks_param
        S_lease_checks = 292,                    // lease_checks
        S_293_33 = 293,                          // $@33
        S_hosts_database = 294,                  // hosts_database
        S_295_34 = 295,                          // $@34
        S_hosts_databases = 296,                 // hosts_databases
        S_297_35 = 297,                          // $@35
        S_database_list = 298,                   // database_list
        S_not_empty_database_list = 299,         // not_empty_database_list
        S_database = 300,                        // database
        S_301_36 = 301,                          // $@36
        S_database_map_params = 302,             // database_map_params
        S_database_map_param = 303,              // database_map_param
        S_database_type = 304,                   // database_type
        S_305_37 = 305,                          // $@37
        S_db_type = 306,                         // db_type
        S_user = 307,                            // user
        S_308_38 = 308,                          // $@38
        S_password = 309,                        // password
        S_310_39 = 310,                          // $@39
        S_host = 311,                            // host
        S_312_40 = 312,                          // $@40
        S_port = 313,                            // port
        S_name = 314,                            // name
        S_315_41 = 315,                          // $@41
        S_persist = 316,                         // persist
        S_lfc_interval = 317,                    // lfc_interval
        S_readonly = 318,                        // readonly
        S_connect_timeout = 319,                 // connect_timeout
        ...
        S_324_42 = 324,                          // $@42
        S_keyspace = 325,                        // keyspace
        S_326_43 = 326,                          // $@43
        S_consistency = 327,                     // consistency
        S_328_44 = 328,                          // $@44
        S_serial_consistency = 329,              // serial_consistency
        S_330_45 = 330,                          // $@45
        ...
        S_hw_address_id = 339,                   // hw_address_id
        S_circuit_id = 340,                      // circuit_id
        S_client_id = 341,                       // client_id
        S_flex_id = 342,                         // flex_id
        S_dhcp_multi_threading = 343,            // dhcp_multi_threading
        S_344_47 = 344,                          // $@47
        S_multi_threading_params = 345,          // multi_threading_params
        S_multi_threading_param = 346,           // multi_threading_param
        S_enable_multi_threading = 347,          // enable_multi_threading
        S_thread_pool_size = 348,                // thread_pool_size
        S_packet_queue_size = 349,               // packet_queue_size
        S_hooks_libraries = 350,                 // hooks_libraries
        S_351_48 = 351,                          // $@48
        S_hooks_libraries_list = 352,            // hooks_libraries_list
        S_not_empty_hooks_libraries_list = 353,  // not_empty_hooks_libraries_list
        S_hooks_library = 354,                   // hooks_library
        S_355_49 = 355,                          // $@49
        S_sub_hooks_library = 356,               // sub_hooks_library
        S_357_50 = 357,                          // $@50
        S_hooks_params = 358,                    // hooks_params
        S_hooks_param = 359,                     // hooks_param
        S_library = 360,                         // library
        S_361_51 = 361,                          // $@51
        S_parameters = 362,                      // parameters
        S_363_52 = 363,                          // $@52
        S_expired_leases_processing = 364,       // expired_leases_processing
        S_365_53 = 365,                          // $@53
        S_expired_leases_params = 366,           // expired_leases_params
        S_expired_leases_param = 367,            // expired_leases_param
        S_reclaim_timer_wait_time = 368,         // reclaim_timer_wait_time
        S_flush_reclaimed_timer_wait_time = 369, // flush_reclaimed_timer_wait_time
        S_hold_reclaimed_time = 370,             // hold_reclaimed_time
        S_max_reclaim_leases = 371,              // max_reclaim_leases
        S_max_reclaim_time = 372,                // max_reclaim_time
        S_unwarned_reclaim_cycles = 373,         // unwarned_reclaim_cycles
        S_subnet4_list = 374,                    // subnet4_list
        S_375_54 = 375,                          // $@54
        S_subnet4_list_content = 376,            // subnet4_list_content
        S_not_empty_subnet4_list = 377,          // not_empty_subnet4_list
        S_subnet4 = 378,                         // subnet4
        S_379_55 = 379,                          // $@55
        S_sub_subnet4 = 380,                     // sub_subnet4
        S_381_56 = 381,                          // $@56
        S_subnet4_params = 382,                  // subnet4_params
        S_subnet4_param = 383,                   // subnet4_param
        S_subnet = 384,                          // subnet
        S_385_57 = 385,                          // $@57
        S_subnet_4o6_interface = 386,            // subnet_4o6_interface
        S_387_58 = 387,                          // $@58
        S_subnet_4o6_interface_id = 388,         // subnet_4o6_interface_id
        S_389_59 = 389,                          // $@59
        S_subnet_4o6_subnet = 390,               // subnet_4o6_subnet
        S_391_60 = 391,                          // $@60
        S_interface = 392,                       // interface
        S_393_61 = 393,                          // $@61
        S_client_class = 394,                    // client_class
        S_395_62 = 395,                          // $@62
        S_require_client_classes = 396,          // require_client_classes
        S_397_63 = 397,                          // $@63
        S_reservations_global = 398,             // reservations_global
        S_reservations_in_subnet = 399,          // reservations_in_subnet
        S_reservations_out_of_pool = 400,        // reservations_out_of_pool
        S_reservation_mode = 401,                // reservation_mode
        S_402_64 = 402,                          // $@64
        S_hr_mode = 403,                         // hr_mode
        S_id = 404,                              // id
        S_shared_networks = 405,                 // shared_networks
        S_406_65 = 406,                          // $@65
        S_shared_networks_content = 407,         // shared_networks_content
        S_shared_networks_list = 408,            // shared_networks_list
        S_shared_network = 409,                  // shared_network
        S_410_66 = 410,                          // $@66
        S_shared_network_params = 411,           // shared_network_params
        S_shared_network_param = 412,            // shared_network_param
        S_option_def_list = 413,                 // option_def_list
        S_414_67 = 414,                          // $@67
        S_sub_option_def_list = 415,             // sub_option_def_list
        S_416_68 = 416,                          // $@68
        S_option_def_list_content = 417,         // option_def_list_content
        S_not_empty_option_def_list = 418,       // not_empty_option_def_list
        S_option_def_entry = 419,                // option_def_entry
        S_420_69 = 420,                          // $@69
        S_sub_option_def = 421,                  // sub_option_def
        S_422_70 = 422,                          // $@70
        S_option_def_params = 423,               // option_def_params
        S_not_empty_option_def_params = 424,     // not_empty_option_def_params
        S_option_def_param = 425,                // option_def_param
        S_option_def_name = 426,                 // option_def_name
        S_code = 427,                            // code
        S_option_def_code = 428,                 // option_def_code
        S_option_def_type = 429,                 // option_def_type
        S_430_71 = 430,                          // $@71
        S_option_def_record_types = 431,         // option_def_record_types
        S_432_72 = 432,                          // $@72
        S_space = 433,                           // space
        S_434_73 = 434,                          // $@73
        S_option_def_space = 435,                // option_def_space
        S_option_def_encapsulate = 436,          // option_def_encapsulate
        S_437_74 = 437,                          // $@74
        S_option_def_array = 438,                // option_def_array
        S_option_data_list = 439,                // option_data_list
        S_440_75 = 440,                          // $@75
        S_option_data_list_content = 441,        // option_data_list_content
        S_not_empty_option_data_list = 442,      // not_empty_option_data_list
        S_option_data_entry = 443,               // option_data_entry
        S_444_76 = 444,                          // $@76
        S_sub_option_data = 445,                 // sub_option_data
        S_446_77 = 446,                          // $@77
        S_option_data_params = 447,              // option_data_params
        S_not_empty_option_data_params = 448,    // not_empty_option_data_params
        S_option_data_param = 449,               // option_data_param
        S_option_data_name = 450,                // option_data_name
        S_option_data_data = 451,                // option_data_data
        S_452_78 = 452,                          // $@78
        S_option_data_code = 453,                // option_data_code
        S_option_data_space = 454,               // option_data_space
        S_option_data_csv_format = 455,          // option_data_csv_format
        S_option_data_always_send = 456,         // option_data_always_send
        S_pools_list = 457,                      // pools_list
        S_458_79 = 458,                          // $@79
        S_pools_list_content = 459,              // pools_list_content
        S_not_empty_pools_list = 460,            // not_empty_pools_list
        S_pool_list_entry = 461,                 // pool_list_entry
        S_462_80 = 462,                          // $@80
        S_sub_pool4 = 463,                       // sub_pool4
        S_464_81 = 464,                          // $@81
        S_pool_params = 465,                     // pool_params
        S_pool_param = 466,                      // pool_param
        S_pool_entry = 467,                      // pool_entry
        S_468_82 = 468,                          // $@82
        S_user_context = 469,                    // user_context
        S_470_83 = 470,                          // $@83
        S_comment = 471,                         // comment
        S_472_84 = 472,                          // $@84
        S_reservations = 473,                    // reservations
        S_474_85 = 474,                          // $@85
        S_reservations_list = 475,               // reservations_list
        S_not_empty_reservations_list = 476,     // not_empty_reservations_list
        S_reservation = 477,                     // reservation
        S_478_86 = 478,                          // $@86
        S_sub_reservation = 479,                 // sub_reservation
        S_480_87 = 480,                          // $@87
        S_reservation_params = 481,              // reservation_params
        S_not_empty_reservation_params = 482,    // not_empty_reservation_params
        S_reservation_param = 483,               // reservation_param
        S_next_server = 484,                     // next_server
        S_485_88 = 485,                          // $@88
        S_server_hostname = 486,                 // server_hostname
        S_487_89 = 487,                          // $@89
        S_boot_file_name = 488,                  // boot_file_name
        S_489_90 = 489,                          // $@90
        S_ip_address = 490,                      // ip_address
        S_491_91 = 491,                          // $@91
        S_ip_addresses = 492,                    // ip_addresses
        S_493_92 = 493,                          // $@92
        S_duid = 494,                            // duid
        S_495_93 = 495,                          // $@93
        S_hw_address = 496,                      // hw_address
        S_497_94 = 497,                          // $@94
        S_client_id_value = 498,                 // client_id_value
        S_499_95 = 499,                          // $@95
        S_circuit_id_value = 500,                // circuit_id_value
        S_501_96 = 501,                          // $@96
        S_flex_id_value = 502,                   // flex_id_value
        S_503_97 = 503,                          // $@97
        ...
        S_client_classes = 511,                  // client_classes
        S_512_101 = 512,                         // $@101
        S_client_classes_list = 513,             // client_classes_list
        S_client_class_entry = 514,              // client_class_entry
        S_515_102 = 515,                         // $@102
        S_client_class_params = 516,             // client_class_params
        S_not_empty_client_class_params = 517,   // not_empty_client_class_params
        S_client_class_param = 518,              // client_class_param
        S_client_class_name = 519,               // client_class_name
        S_client_class_test = 520,               // client_class_test
        S_521_103 = 521,                         // $@103
        S_only_if_required = 522,                // only_if_required
        S_dhcp4o6_port = 523,                    // dhcp4o6_port
        S_control_socket = 524,                  // control_socket
        S_525_104 = 525,                         // $@104
        S_control_socket_params = 526,           // control_socket_params
        S_control_socket_param = 527,            // control_socket_param
        S_control_socket_type = 528,             // control_socket_type
        S_529_105 = 529,                         // $@105
        S_control_socket_name = 530,             // control_socket_name
        S_531_106 = 531,                         // $@106
        S_dhcp_queue_control = 532,              // dhcp_queue_control
        S_533_107 = 533,                         // $@107
        S_queue_control_params = 534,            // queue_control_params
        S_queue_control_param = 535,             // queue_control_param
        S_enable_queue = 536,                    // enable_queue
        S_queue_type = 537,                      // queue_type
        S_538_108 = 538,                         // $@108
        S_capacity = 539,                        // capacity
        S_arbitrary_map_entry = 540,             // arbitrary_map_entry
        S_541_109 = 541,                         // $@109
        S_dhcp_ddns = 542,                       // dhcp_ddns
        S_543_110 = 543,                         // $@110
        S_sub_dhcp_ddns = 544,                   // sub_dhcp_ddns
        S_545_111 = 545,                         // $@111
        S_dhcp_ddns_params = 546,                // dhcp_ddns_params
        S_dhcp_ddns_param = 547,                 // dhcp_ddns_param
        S_enable_updates = 548,                  // enable_updates
        S_server_ip = 549,                       // server_ip
        S_550_112 = 550,                         // $@112
        S_server_port = 551,                     // server_port
        S_sender_ip = 552,                       // sender_ip
        S_553_113 = 553,                         // $@113
        S_sender_port = 554,                     // sender_port
        S_max_queue_size = 555,                  // max_queue_size
        S_ncr_protocol = 556,                    // ncr_protocol
        S_557_114 = 557,                         // $@114
        S_ncr_protocol_value = 558,              // ncr_protocol_value
        S_ncr_format = 559,                      // ncr_format
        S_560_115 = 560,                         // $@115
        S_dep_qualifying_suffix = 561,           // dep_qualifying_suffix
        S_562_116 = 562,                         // $@116
        S_dep_override_no_update = 563,          // dep_override_no_update
        S_dep_override_client_update = 564,      // dep_override_client_update
        S_dep_replace_client_name = 565,         // dep_replace_client_name
        S_566_117 = 566,                         // $@117
        S_dep_generated_prefix = 567,            // dep_generated_prefix
        S_568_118 = 568,                         // $@118
        S_dep_hostname_char_set = 569,           // dep_hostname_char_set
        S_570_119 = 570,                         // $@119
        S_dep_hostname_char_replacement = 571,   // dep_hostname_char_replacement
        S_572_120 = 572,                         // $@120
        ...
        S_loggers = 582,                         // loggers
        S_583_124 = 583,                         // $@124
        S_loggers_entries = 584,                 // loggers_entries
        S_logger_entry = 585,                    // logger_entry
        S_586_125 = 586,                         // $@125
        S_logger_params = 587,                   // logger_params
        S_logger_param = 588,                    // logger_param
        S_debuglevel = 589,                      // debuglevel
        S_severity = 590,                        // severity
        S_591_126 = 591,                         // $@126
        S_output_options_list = 592,             // output_options_list
        S_593_127 = 593,                         // $@127
        S_output_options_list_content = 594,     // output_options_list_content
        S_output_entry = 595,                    // output_entry
        S_596_128 = 596,                         // $@128
        S_output_params_list = 597,              // output_params_list
        S_output_params = 598,                   // output_params
        S_output = 599,                          // output
        S_600_129 = 600,                         // $@129
        S_flush = 601,                           // flush
        S_maxsize = 602,                         // maxsize
        S_maxver = 603,                          // maxver
        S_pattern = 604,                         // pattern
        S_605_130 = 605                          // $@130
      };
    };
...
switch (yykind)
  ...
  private:
    ...
    enum
    {
      ...
      yynnts_ = 409,  ///< Number of nonterminal symbols.
