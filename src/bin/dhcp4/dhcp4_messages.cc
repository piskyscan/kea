...
extern const isc::log::MessageID DHCP4_TESTING_MODE_ENABLED = "DHCP4_TESTING_MODE_ENABLED";
...
const char* values[] = {
    ...
    "DHCP4_TESTING_MODE_ENABLED", "dhcp4 running in the test mode. All packets will be send to source address of an incoming packet",
