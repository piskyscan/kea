...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOKEN_RESERVATIONS_IN_SUBNET = 357, // "reservations-in-subnet"
    TOKEN_RESERVATIONS_OUT_OF_POOL = 358, // "reservations-out-of-pool"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_RESERVATIONS_IN_SUBNET = 102,          // "reservations-in-subnet"
        S_RESERVATIONS_OUT_OF_POOL = 103,        // "reservations-out-of-pool"
        ...
        S_403_63 = 403,                          // $@63
        S_reservations_global = 404,             // reservations_global
