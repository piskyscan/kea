...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOKEN_ALL = 356,               // "all"
    TOKEN_RESERVATIONS_GLOBAL = 357, // "reservations-global"
    TOKEN_RESERVATIONS_IN_SUBNET = 358, // "reservations-in-subnet"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_GLOBAL = 100,                          // "global"
        S_ALL = 101,                             // "all"
        S_RESERVATIONS_GLOBAL = 102,             // "reservations-global"
        S_RESERVATIONS_IN_SUBNET = 103,          // "reservations-in-subnet"
