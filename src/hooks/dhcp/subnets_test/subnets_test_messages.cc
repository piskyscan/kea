...
const char* values[] = {
    ...
    "SUBNETS_TEST_SUBNET4_SELECT_ERROR", "Subnets test hooks library subnet4 select error",
    "SUBNETS_TEST_SUBNET6_SELECT_ERROR", "Subnets test hooks library subnet6 select error",
